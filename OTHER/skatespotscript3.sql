...
INSERT INTO `spot` (`id`, `author_id`, `name`, `description`, `adress`, `cp`, `city`, `lat`, `lng`, `creation_date`, `is_validated`) VALUES
	(1, 1, 'Musée d\'art Moderne et contemporain (ZEMS)', 'Ici c\'est le musée d\'art contemporain c\'est le QG des skater a stras, bon sol, bon curbs', NULL, NULL, NULL, 48.58, 7.737, '2023-05-17 07:00:22', 1),
	(2, 2, 'Place kléber', 'bon sol mais bcp de monde attention aux touristes', NULL, NULL, NULL, 48.583315, 7.745908, '2023-05-17 07:02:52', 1);
