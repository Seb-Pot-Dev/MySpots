...
-- Listage des données de la table skatespot.comment : ~0 rows (environ)
...
-- Listage des données de la table skatespot.messenger_messages : ~1 rows (environ)
...
-- Listage des données de la table skatespot.spot : ~5 rows (environ)
INSERT INTO `spot` (`id`, `author_id`, `name`, `description`, `adress`, `cp`, `city`, `lat`, `lng`, `creation_date`, `is_validated`) VALUES
	...
	(6, 1, 'Nom de spot 0', 'blablaaa', NULL, NULL, NULL, 48.586, 7.771, '2023-05-12 12:28:47', 0),
	(8, 1, 'Nom de spot 6', 'zerldf', NULL, NULL, NULL, 48.58856, 7.754116, '2023-05-12 12:27:57', 1),
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `pseudo`, `registration_date`) VALUES
	(1, 'admin@admin.com', '["ROLE_ADMIN"]', '$2y$13$Ng/c4aoXNX0od2mEktVMDeBtbgq5obBfaze35dOg2ydNy7dnPXx7q', 0, 'my_admin', '2023-05-12 06:47:31');
